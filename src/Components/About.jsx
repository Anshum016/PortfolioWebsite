  ...
  return (
    <div className="min-h-screen pt-24 pb-36 px-6">
      <div className="max-w-5xl mx-auto">
        ...
        <p className="text-center mb-12" style={{ color: 'rgba(255, 255, 255, 0.7)' }}>My Introduction</p>
        
        <div className="flex flex-col md:flex-row items-center md:items-start gap-12">
          <div className="w-full md:w-1/3">
            <div className="rounded-xl w-full h-80 mx-auto overflow-hidden shadow-lg" style={{ backgroundColor: 'rgba(25, 22, 39, 0.5)', borderColor: 'var(--accent-color)', borderWidth: '2px' }}>
              {/* About me image */}
              <img 
          ...
          <div className="w-full md:w-2/3">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
              <div className="text-center p-4 shadow-md rounded-lg" style={{ backgroundColor: 'rgba(25, 22, 39, 0.5)' }}>
                <h3 className="text-2xl font-bold" style={{ color: 'var(--accent-color)' }}>5+</h3>
                <p style={{ color: 'rgba(255, 255, 255, 0.8)' }}>Years experience</p>
              </div>
              <div className="text-center p-4 shadow-md rounded-lg" style={{ backgroundColor: 'rgba(25, 22, 39, 0.5)' }}>
                <h3 className="text-2xl font-bold" style={{ color: 'var(--accent-color)' }}>15+</h3>
                <p style={{ color: 'rgba(255, 255, 255, 0.8)' }}>Projects completed</p>
              </div>
              <div className="text-center p-4 shadow-md rounded-lg" style={{ backgroundColor: 'rgba(25, 22, 39, 0.5)' }}>
                <h3 className="text-2xl font-bold" style={{ color: 'var(--accent-color)' }}>3+</h3>
                <p style={{ color: 'rgba(255, 255, 255, 0.8)' }}>Companies worked</p>
              </div>
            </div>
            ...
            <div className="flex justify-center md:justify-start">
              <a 
                ...
                className="inline-block px-6 py-3 rounded-lg transition-colors font-medium mb-8"
                style={{ 
