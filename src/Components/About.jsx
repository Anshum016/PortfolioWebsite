  ...
  return (
    <div className="min-h-screen pt-28 pb-24 px-4 sm:px-6">
      <div className="max-w-5xl mx-auto">
        <h2 className="text-4xl sm:text-5xl font-bold text-center mb-4 bg-gradient-to-r from-blue-400 to-purple-500 bg-clip-text text-transparent">About Me</h2>
        ...
        <div className="flex flex-col md:flex-row items-center md:items-start gap-16 md:gap-24 lg:gap-32">
          ...
          <div className="w-full md:w-2/3 md:pl-8 lg:pl-12">
            <div className="space-y-6 sm:space-y-8">
              <div className="relative">
                ...
                <p className="text-base sm:text-lg leading-relaxed pl-4" style={{ color: 'rgba(255, 255, 255, 0.9)' }}>
                  I am a <span className="font-semibold text-blue-400">B.Tech Computer Science</span> student at Parul University, passionate about 
                  <span className="font-semibold text-purple-400"> AI/ML and web development</span>. Currently working as an AI/ML Intern at Tinkering Hub, 
              ...
              <div className="relative">
                <div className="absolute -left-4 top-0 w-1 h-full rounded-full" style={{ backgroundColor: 'var(--accent-color)' }}></div>
                <p className="text-base sm:text-lg leading-relaxed pl-4" style={{ color: 'rgba(255, 255, 255, 0.9)' }}>
                  My expertise spans across <span className="font-semibold text-blue-400">Computer Vision</span>, 
                  <span className="font-semibold text-purple-400"> NLP</span>, and 
                  <span className="font-semibold text-blue-400"> Full Stack Development</span>. I have hands-on experience 
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 sm:gap-6 my-12">
              ...
              >
                <h3 className="text-2xl sm:text-3xl font-bold mb-2 bg-gradient-to-r from-blue-400 to-purple-500 bg-clip-text text-transparent">2+</h3>
              ...
              >
                <h3 className="text-2xl sm:text-3xl font-bold mb-2 bg-gradient-to-r from-blue-400 to-purple-500 bg-clip-text text-transparent">3+</h3>
              ...
              >
                <h3 className="text-2xl sm:text-3xl font-bold mb-2 bg-gradient-to-r from-blue-400 to-purple-500 bg-clip-text text-transparent">2026</h3>
            ...
            <div className="flex flex-col sm:flex-row justify-center md:justify-start gap-4">
              <a 
                ...
                className="inline-flex items-center justify-center px-6 sm:px-8 py-3 sm:py-4 rounded-xl transition-all duration-300 transform hover:scale-105 font-medium"
                style={{ 
              ...
              <a 
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center justify-center gap-2 px-6 sm:px-8 py-3 sm:py-4 rounded-xl transition-all duration-300 transform hover:scale-105 font-medium"
                style={{ 
                  backgroundColor: 'rgba(25, 22, 39, 0.5)', 
                  color: 'white',
